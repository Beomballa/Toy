...
public class FrontCommerceRestController {
    ...
    @GetMapping("/member/order-claims/{claimNo}/history")
    public List<FrontMemberOrderClaimHistoryResponse> getMemberOrderClaimHistory(
    ...
    public FrontOrderReorderResponse reorderMemberOrder(
        ...
        return commerceService.reorderMemberOrder(memberNo(request), orderNumber, cartToken);
    }
