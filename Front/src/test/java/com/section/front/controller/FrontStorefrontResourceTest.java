...
class FrontStorefrontResourceTest {
    ...
    void myActivityKeepsPasswordChangeAndResponsiveContracts() throws IOException {
        ...
        assertThat(html)
                ...
                .contains("data-password-toggle=\"memberCurrentPassword\"")
                .contains("data-caps-note")
                .contains("id=\"memberProfileForm\"")
                .contains("id=\"memberLogoutButton\"")
                .contains("id=\"memberOrderClaimsList\"")
                .contains("/js/view/my-activity.js?v=20260907.4")
                .contains("/css/my-activity.css?v=20260907.4");
        assertThat(script)
    ...
    void detailPageKeepsCommerceVisualAndPrimaryActionHooks() throws IOException {
        ...
        assertThat(readResource("static/js/view/detail.js"))
                ...
                .contains("function normalizeRatingDistribution(")
                .contains("function updateReviewContentCount(")
    ...
    void orderLookupKeepsPrivateVerificationAndTrackingHooks() throws IOException {
        ...
        assertThat(html)
                ...
                .contains("/css/commerce.css?v=20260907.1")
                .contains("/js/view/order-lookup.js?v=20260907.1");
        assertThat(script)
                ...
                .contains("function normalizeLookupInput(")
    ...
    void brandDirectoryKeepsFacetMetricsPagingAndPersonalBoardContracts() throws IOException {
        ...
        assertThat(script)
                ...
                .contains("function normalizeDirectoryResponse(")
    ...
    void productCollectionKeepsIndependentNavigationServerPagingAndDetailCta() throws IOException {
        ...
        assertThat(html)
                ...
                .contains("/js/view/product-collection.js?v=20260820.3")
    ...
    void publicContentDetailKeepsReadableSafeAndRecoverableContract() throws IOException {
        ...
        assertThat(script)
                ...
                .contains("function normalizeContentDetail(value)")
                .contains("function normalizeReaction(value, expectedReaction = null)")
                .contains("function normalizeRelatedContents(value, boardType)")
                .contains("id !== documentId")
                .contains("totalCount !== helpfulCount + notHelpfulCount")
                .contains("detailRequestController?.abort()")
                .contains("requestSequence !== reactionRequestSequence")
                .contains("value.slice(0, 100).flatMap")
    ...
    void publicContentArchiveKeepsSearchPagingAndSafeRenderingContract() throws IOException {
        ...
        assertThat(script)
                ...
                .contains("function normalizeContentPage(value)")
                .contains("function normalizeContentItems(value)")
                .contains("pageViewCount !== items.reduce")
                .contains("pageNoticeCount + pageStyleCount !== items.length")
                .contains("value.sort !== state.sort")
                .contains("value.slice(0, limit * 3)")
    ...
    void productComparisonKeepsRefreshDecisionAndResponsiveTableContract() throws IOException {
        ...
        assertThat(script)
                ...
                .contains("Number.isSafeInteger(id)")
                .contains("function normalizeProductResponse(")
                .contains("function normalizeOptions(")
                .contains("id !== expectedId")
                .contains("options.reduce((sum, option) => sum + option.stock, 0) !== stock")
