...
class ProductFrontDisplayExportSummaryTest {
    ...
    void ofReturnsDefaultSummaryWhenNoFilterApplied() {
        ProductFrontDisplayExportSummary summary = ProductFrontDisplayExportSummary.of(
                new AdminFrontDisplayProductQuery(null, null, null, null, null, false, false, 20L, "FEATURED"),
                null,
                null
        );
    ...
    void ofReturnsReadableFilterSummary() {
        ProductFrontDisplayExportSummary summary = ProductFrontDisplayExportSummary.of(
                new AdminFrontDisplayProductQuery("Grey", ProductStatus.ACTIVE, 7L, 11L, true, true, true, 30L, "PRICE_LOW"),
                "New Balance",
                "러닝화"
        );
        ...
        assertEquals(
                "검색어: Grey | 상태: 판매중 | 브랜드: New Balance | 카테고리: 러닝화 | 노출 설정: 설정됨 | Featured만 | 저재고: 30개 미만",
